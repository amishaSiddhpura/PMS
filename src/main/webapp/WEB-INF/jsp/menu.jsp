...
<style>
    *{margin:0;padding:0;text-decoration:none}
    ...
    .logo{position:relative;z-index:123;text-align: center;padding:10px;font:18px verdana;color:#00a2ff;float:left;width:15%}
    .logo a{color:#00a2ff;}
        ...
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li><a href='${pageContext.request.contextPath}/showProjects'>Show Project</a></li>
                    ...
                    <li><a href='${pageContext.request.contextPath}/addTask'>Add Tasks</a></li>
                    <li><a href='${pageContext.request.contextPath}/memberStat'>Member Statistics</a></li>
                </c:if>

                <c:if test="${userRole eq '[ROLE_MEMBER]'}">
                    <li><a href='${pageContext.request.contextPath}/myTask'>Assigned Task</a></li>
                    <li><a href='${pageContext.request.contextPath}/listMember'>Show Project Members</a></li>
                </c:if>

                <c:if test="${userRole eq '[ROLE_ADMIN]'}">
                    <li><a href='${pageContext.request.contextPath}/addUser'>Add User</a></li>
                    <li><a href='${pageContext.request.contextPath}/showUsers'>Show User</a></li>
